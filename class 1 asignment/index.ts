...
let placestovisits = ['madina','makkah','kpk',"afghanistann",'kashmir'];
...
console.log([...placestovisits].sort());
...
//Excercise 17
//countries list
let cities = ["New York", "Paris", "Tokyo", "London", "Sydney", "Rome", "Mumbai", "Cairo", "Beijing", "Rio de Janeiro"];
...
type Country = {
  ...
  //Excersice 19
  let city = ["New York", "Paris", "Tokyo", "London", "Sydney", "Rome", "Mumbai", "Cairo", "Beijing", "Rio de Janeiro"];
